defmodule IslandsEngine.Rules do
  ...
  # Players can position their islands in :players_set
  ...
  def check(%Rules{state: :player1_turn} = rules, {:win_check, win_or_not}), do: win_check(rules, win_or_not)
  def check(%Rules{state: :player2_turn} = rules, {:win_check, win_or_not}), do: win_check(rules, win_or_not)
  ...
  defp win_check(rules, win_or_not) do
    case win_or_not do
